    ...
    return (
        <StyledAbout>
            <StyledDescription>
                ...
                <motion.p variants={fade}>For the past 7 years I have been working as a digital marketing freelancer, and for the past year and a half, I have started to seriously focus on improving my Front End Dev Stack.</motion.p>
